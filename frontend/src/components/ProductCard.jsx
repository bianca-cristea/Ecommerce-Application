      ...
      <div className='p-4'>
          ...
          <div className='flex items-center justify-between'>
            ...
            <button 
              ...
              onClick={() => {}}
              className={`bg-blue-500 ${isAvailable ? "opacity-100 hover:bg-blue-600" : "opacity-60"}
                text-white py-2 px-3 rounded-lg  cursor-pointer items-center transition-colors duration-300 w-36 flex justify-center`}>
